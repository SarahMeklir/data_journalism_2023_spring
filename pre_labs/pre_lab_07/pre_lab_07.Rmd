...
Is the difference between Calvert and Montgomery significant? **Answer** Yes. The margin for error in Calvert is much larger, which gives it a potentially much higher max median income than Montgomery.

Is the difference between Howard and everyone else significant? **Answer** Yes. Howard's minimum median income is still significantly above the next closest  county.
...
**Answer** Baltimore City was the largest, then Allegany County. I don't think any median incomes fell but Caroline County had the lowest growth. 
...
**Answer** Is there a correlation between median income and enrollment rates after graduation? Vocational schools and military or other similar outliers could complicate that answer.
...
**Answer** High schools in wealthier areas sent more people to college in that timespan.
...
**Answer** Are there outliers, with low median income and high enrollment rates? Where are they? Why are they that way?
