...
**Answer** Maryland shouldn't be the title, because it has data that needs to be contained by a row. The columns don't have headers and there are a ton of periods and no distinction between the areas and counties.
...
**Answer** It makes Maryland the first row, rather than the title row. There still aren't any dates, though, and no titles for the columns. Also, there is no distinction of the region names versus county names. 
...
**Answer** Yay, we have column names! We still need to distinguish between counties and totals for regions, otherwise sorting is going to be crazy.
...
**I'm scared to mess up the data, but I believe you!**
