...
We used this site: https://www.courts.state.md.us/media/news 
...
**Answer** 
The news release is very descriptive.
```{r}
...
**Answer** 
Hooray for numbers! I'd like to have a county column and somehow sort by type of event.
```{r}
...
**Answer** 
It doesn't really get into information until row 17. 
```{r}
